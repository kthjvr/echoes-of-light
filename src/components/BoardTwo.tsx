...
const BoardTwo: React.FC<BoardTwoProps> = ({ onComplete }) => {
  ...
  const cardData = useMemo(
    () => [
      ...
      {
        img: "https://ik.imagekit.io/e3wiv79bq/echoes-of-light/2.png?updatedAt=1740544753528",
        id: uuidv4(),
        alt: 3,
        isFlipped: false,
      },
      ...
      {
        img: "https://ik.imagekit.io/e3wiv79bq/echoes-of-light/6.png?updatedAt=1740544753899",
        id: uuidv4(),
        alt: 5,
        isFlipped: false,
      },
      {
        img: "https://ik.imagekit.io/e3wiv79bq/echoes-of-light/4.png?updatedAt=1740544753436",
        id: uuidv4(),
        alt: 6,
        isFlipped: false,
      },
