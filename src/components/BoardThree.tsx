...
interface BoardThreeProps {
  onComplete: () => void; // Define the type of the onComplete prop
}

const BoardThree: React.FC<BoardThreeProps> = ({ onComplete }) => {
  ...
  const cardData = useMemo(
    () => [
      {
        img: "https://ik.imagekit.io/e3wiv79bq/echoes-of-light/Level3/9.png?updatedAt=1740645677437",
        id: uuidv4(),
        alt: 1,
        isFlipped: false,
      },
      ...
      {
        img: "https://ik.imagekit.io/e3wiv79bq/echoes-of-light/Level3/10.png?updatedAt=1740645678140",
        id: uuidv4(),
        alt: 2,
        isFlipped: false,
      },
      ...
      {
        img: "https://ik.imagekit.io/e3wiv79bq/echoes-of-light/Level3/11.png?updatedAt=1740645678654",
        id: uuidv4(),
        alt: 3,
        isFlipped: false,
      },
      ...
      {
        img: "https://ik.imagekit.io/e3wiv79bq/echoes-of-light/Level3/12.png?updatedAt=1740645678216",
        id: uuidv4(),
        alt: 4,
        isFlipped: false,
      },
      ...
      {
        img: "https://ik.imagekit.io/e3wiv79bq/echoes-of-light/Level3/13.png?updatedAt=1740645678067",
        id: uuidv4(),
        alt: 5,
        isFlipped: false,
      },
      ...
      {
        img: "https://ik.imagekit.io/e3wiv79bq/echoes-of-light/Level3/14.png?updatedAt=1740645677441",
        id: uuidv4(),
        alt: 6,
        isFlipped: false,
      },
      ...
      {
        img: "https://ik.imagekit.io/e3wiv79bq/echoes-of-light/Level3/15.png?updatedAt=1740645676040",
        id: uuidv4(),
        alt: 7,
        isFlipped: false,
      },
      ...
      {
        img: "https://ik.imagekit.io/e3wiv79bq/echoes-of-light/Level3/16.png?updatedAt=1740645677578",
        id: uuidv4(),
        alt: 8,
        isFlipped: false,
      },
      ...
      {
        img: "https://ik.imagekit.io/e3wiv79bq/echoes-of-light/Level3/17.png?updatedAt=1740645677865",
        id: uuidv4(),
        alt: 9,
        isFlipped: false,
      },
  ...
  return (
    <div className="px-3 sm:px-4 py-4 sm:py-6 text-white">
      ...
      {/* Card Grid */}
    <div className="max-w-xs sm:max-w-md md:max-w-4xl mx-auto mb-6 sm:mb-8">
      <div className="grid grid-cols-3 gap-2 sm:gap-3 p-3 sm:p-4 md:grid-cols-6 md:gap-4 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
